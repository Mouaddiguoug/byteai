...
class Data {
  ...
  Data({this.id, this.customerId, this.name, this.email, this.phone, this.photo, this.status, this.writerLimit, this.chatLimit, this.imageLimit, this.createdAt, this.updatedAt, this.accesstoken});
