                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Create account'.tr, style: const TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.w600)),
                            Text('Create to you new account.'.tr, style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400)),
                            const SizedBox(
                              height: 50,
                            ),
                            Text(
